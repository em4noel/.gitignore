...
public class Usuario {
    ...
    public Usuario(Long codg_usuario, @NotNull(message = "Campo requerido") String login,
            @NotNull(message = "Campo requerido") String senha, @NotNull(message = "Campo requerido") String role) {
        super();
        this.codg_usuario = codg_usuario;
        this.login = login;
        this.senha = senha;
